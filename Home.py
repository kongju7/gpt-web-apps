...
이 사이트는 OpenAI(`GPT`) API를 활용한 몇 가지 애플리케이션(기본형)을 직접 구현해 본 사이트입니다.   
  
  
  
- <a href="/DocumentAPP" target="_self">DocumentAPP</a> : 문서 톺아보기 
- <a href="/SecureDocumentAPP" target="_self">SecureDocumentAPP</a> : 로컬 LLM 활용하여 보안문서 톺아보기 
- <a href="/QuizAPP" target="_self">QuizAPP</a> : 문제 출제하고 맞추기 
- <a href="/SiteAPP" target="_self">SiteAPP</a> : 사이트 톺아보기 
- <a href="/MeetingAPP" target="_self">MeetingAPP</a> : 비디오 음성인식 및 요약   
